...
void boat()
{
    ...
    glVertex2f(0.8f, -0.8803+0.2f);
    glVertex2f(0.8f, -0.8271+0.2f);
    glVertex2f(0.448f, -0.72+0.2f);
    glVertex2f(0.384f, -0.7739+0.2f);
    glVertex2f(0.448f, -0.8404+0.2f);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(114, 218, 227);
    glVertex2f(0.648f, -0.78+0.2f);
    glVertex2f(0.665f, -0.69+0.2f);
    glVertex2f(0.504f, -0.681+0.2f);
    glVertex2f(0.48f, -0.73+0.2f);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(247, 245, 237);
    glVertex2f(0.57f, -0.7569+0.2f);
    glVertex2f(0.58f, -0.7+0.2f);
    glVertex2f(0.515f, -0.6943+0.2f);
    glVertex2f(0.5f, -0.7358+0.2f);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(247, 245, 237);
    glVertex2f(0.635f, -0.778+0.2f);
    glVertex2f(0.649f, -0.70+0.2f);
    glVertex2f(0.595f, -0.7+0.2f);
    glVertex2f(0.582f, -0.765+0.2f);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.792f, -0.8803+0.2f);
    glVertex2f(0.792f, -0.8537+0.2f);
